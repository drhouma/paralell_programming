...
#pragma omp parallel private(id, size)
    {  // Начало параллельной области
        ...
        // своей части массива
        // директива critical не позволит потокам одновременно изменить значение
        // переменной sum, они будут делать это друг за другом, что позволит 
        // правильно вычислять сумму всех элементов 
        #pragma omp critical summator
